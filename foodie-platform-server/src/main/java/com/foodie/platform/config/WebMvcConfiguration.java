...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    @Autowired
    private JwtTokenPlatformInterceptor jwtTokenPlatformInterceptor;
    ...
    public Docket docket() {
        ...
        ApiInfo apiInfo = new ApiInfoBuilder()
                .title("吃货联盟平台端接口文档")
                .version("1.0")
                .description("吃货联盟平台端接口文档")
                .build();

        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.foodie.platform.controller"))
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                ...
                .allowedOrigins("http://localhost:5178") // 或者前端地址 http://localhost:8080
