      ...
      <div class="mt-form-box">
        <van-form @submit="onSubmit">
          ...
          <div class="mt-submit-wrap">
            ...
            <van-button round block plain native-type="button" class="mt-register-btn" @click="goRegister">注 册</van-button>
          </div>
        </van-form>
...
<script setup>
import { useLoginPage } from '@/composables/business/useLoginPage'
