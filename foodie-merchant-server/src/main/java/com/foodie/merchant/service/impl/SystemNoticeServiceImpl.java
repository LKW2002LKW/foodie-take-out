...
import com.foodie.merchant.mapper.SystemNoticeMapper;
import com.foodie.merchant.service.SystemNoticeService;
...
public class SystemNoticeServiceImpl implements SystemNoticeService {
    ...
    public SystemNoticeVO getNoticeDetail(Long noticeId) {
        ...
        if (notice.getTarget() != NoticeConstant.TARGET_MERCHANT
